...
namespace VerticesEngine.AppDemo
{
    ...
    [vxRegisterAsSandboxEntity("Ford Fiesta", SandboxCategories.GridItems, SandboxSubCategories.GridItems, "Models/vehicles/ford/model")]
    //[vxRegisterAsSandboxEntityAttribute("Ford Fiesta", SandboxCategories.GridItems, SandboxSubCategories.GridItems, "Models/vehicles/lancer/lancer")]
    public class DrivableVehicle : TechDemoItem
    {
        ...
        protected override void OnPhysicsColliderSetup()
        {
           ...
           var PhysicsCollider = new Box(Vector3.Zero, 3, 0.5f, 4, 100);
            PhysicsCollider.CollisionInformation.LocalPosition = new Vector3(0, 0.5f, 0);
            ...
            //PhysicsCollider.IsAffectedByGravity = false;
            ...
            if (ctorcount > 0)
            {
                ...
                foreach (Wheel wheel in Vehicle.Wheels)
                {
                    ...
                    wheel.Suspension.SolverSettings.MaximumIterationCount = 10;
                    wheel.Brake.SolverSettings.MaximumIterationCount = 10;
                    wheel.SlidingFriction.SolverSettings.MaximumIterationCount = 10;
                    wheel.DrivingMotor.SolverSettings.MaximumIterationCount = 10;
        ...
        protected override void Update()
        {
            ...
            //this.WorldTransform = Matrix.CreateScale(0.75f) * Matrix.CreateTranslation(Vector3.Up * 0.5f) * Vehicle.Body.WorldTransform;
            Transform = Vehicle.Body.WorldTransform.ToTransform();
            Transform.Scale = 0.75f * Vector3.One;
