...
//using Virtex.Engine;
////using Virtex.Engine.PhysicsDrawer.Models;
//using Virtex.Engine.Physics;
//using Virtex.Engine.Physics.Vehicle;
//using Virtex.Engine.Physics.CollisionShapes;
//using Virtex.Engine.Physics.CollisionShapes.ConvexShapes;
//using Virtex.Engine.Physics.Entities.Prefabs;

//namespace VirtexTemplate
//{
//    /// <summary>
...
//            Vehicle.AddWheel(new Wheel(
//                     new RaycastWheelShape(Wheel_RAD, wheelGraphicRotation),
//                     new WheelSuspension(2000, 100f, Vector3.Down, .8f, new Vector3(0, 0, 2 * Wheel_Pos_L)),
//                     new WheelDrivingMotor(2.5f, 30000, 10000),
//                     new WheelBrake(1.5f, 2, .02f),
//                     new WheelSlidingFriction(Wheel_Friction, Wheel_Friction_Static)));*/
