...
namespace VerticesEngine.AppDemo
{
    public class TrackEntity : vxEntity3D
    {
        ...
        //{
        //    vxMesh tempModel = vxEngine.Instance.ContentManager.LoadModel("Models/track/track");

        //    //vxMeshMesh newmesh = new vxMeshMesh();
        ...
        //    }
        //    vxMeshMeshPart newpart = new vxMeshMeshPart(verts.ToArray(),
        //                                              indices.ToArray(),
